...
# taking out developed land (slightly weaker than above aic = 732.84), taking out developed land and agriculture (weaker model, aic = 937.31)
h8a <- glm(prop_vec ~ lc_class20 +
            lc_class33 + # high std. error (?)
            #lc_class34 +
            lc_class50 +
            lc_class110 +
            #lc_class120 +
